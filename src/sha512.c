...
#define SWAP(n) u64or (u64or (u64or (u64shl (n, 56), u64shl(u64and (n, u64lo (0x0000ff00)), 40)), u64or (u64shl (u64and (n, u64lo (0x00ff0000)), 24), u64shl (u64and (n, u64lo (0xff000000)),  8))), u64or (u64or (u64and (u64shr (n,  8), u64lo (0xff000000)), u64and (u64shr (n, 24), u64lo (0x00ff0000))), u64or (u64and (u64shr (n, 40), u64lo (0x0000ff00)), u64shr (n, 56))))
// #define SWAP(n) (n)
...
static void sha512_conclude_ctx(struct sha512_ctx* ctx)
{
	...
	set_uint64((char*)&ctx->buffer[size - 2], SWAP(u64or(u64shl(ctx->total[1], 3), u64shr(ctx->total[0], 61))));
...
void sha512_process_block(const void* buffer, size_t len, struct sha512_ctx* ctx)
{
	...
	ctx->total[1] = u64plus(ctx->total[1], u64plus(u64size(len >> 31 >> 31 >> 2), u64lo(u64lt(ctx->total[0], lolen))));
